...
var ie = { current: null },
    wr = { transition: null },
    yc = { ReactCurrentDispatcher: ie, ReactCurrentBatchConfig: wr, ReactCurrentOwner: Ao };
function qi() {
    ...
    ws(function () {
        ...
        if (!(n & 7)) {
            ...
            switch (((x = c ? Un(c) : window), e)) {
                case 'focusin':
                    (ni(x) || x.contentEditable === 'true') && ((In = x), (fo = c), (_t = null));
                    break;
                case 'focusout':
                    _t = fo = In = null;
                    break;
...
function ta(e) {
    ...
    function S(f, a, d, h) {
        ...
        if (T.done) return t(f, _), F && gn(f, P), E;
        if (_ === null) {
...
function nd(e, n, t) {
    ...
    if (Ca(e)) xa(n, l);
        ...
        (t = la(e, n, l, r)), t !== null && ((l = ue()), Oe(t, e, r, l), _a(t, n, r));
    }
}
function Ca(e) {
    var n = e.alternate;
...
function Li(e, n, t, r, l) {
    ...
    if ((Gn(n, l), n.stateNode === null)) Pr(e, n), Pa(n, t, r), xo(n, t, r, l), (r = !0);
    else if (e === null) {
        var u = n.stateNode,
            i = n.memoizedProps;
        u.props = i;
            ...
            return n.flags & 128
                ...
                : ((r = r !== null),
                  r !== (e !== null && e.memoizedState !== null) &&
                      r &&
                      ((n.child.flags |= 8192),
                      n.mode & 1 && (e === null || U.current & 1 ? X === 0 && (X = 3) : Nu())),
                  n.updateQueue !== null && (n.flags |= 4),
                  te(n),
                  null);
        case 4:
            return nt(), To(e, n), e === null && $t(n.stateNode.containerInfo), te(n), null;
        case 10:
...
function Ka(e) {
    ...
    (e.memoizedProps = e.pendingProps), n === null ? Ya(e) : (K = n), (Eu.current = null);
}
function Ya(e) {
    var n = e;
    do {
...
ys = _u;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, vs, hs, _u] },
    ht = {
...
const Rd = () => {
        const [e, n] = Tt.useState('black'),
            [t, r] = Tt.useState('black'),
            l = (u) => {
                const { value: i } = u.target;
                r(i);
            },
            o = () => {
                n(t);
        ...
        return Q.jsxs('div', {
            ...
            children: [
                Q.jsxs('h2', {
                    style: { color: e, fontSize: 100, fontWeight: 900 },
                    children: ['컬러 : ', e],
                }),
                ' ',
                Q.jsx('hr', {}),
                Q.jsxs('select', {
                    ...
                    children: [
                        Q.jsx('option', { value: 'red', children: 'red' }),
                        Q.jsx('option', { value: 'orange', children: 'orange' }),
                        Q.jsx('option', { value: 'orange', children: 'yellow' }),
                        Q.jsx('option', { value: 'green', children: 'green' }),
                        Q.jsx('option', { value: 'blue', children: 'blue' }),
                        Q.jsx('option', { value: 'purple', children: 'purple' }),
                    ],
                }),
                Q.jsx('br', {}),
                Q.jsx('br', {}),
                Q.jsx('br', {}),
                Q.jsx('p', {
                    children: '1. onView 함수 2.textColor 상태변수만들기 3. 확인눌러야 컬러변경',
                }),
                Q.jsx('button', { onClick: o, children: '확인' }),
            ],
        });
    },
    Od = () => Q.jsx(Q.Fragment, { children: Q.jsx(Rd, {}) });
Ql.createRoot(document.getElementById('root')).render(
    Q.jsx(gc.StrictMode, { children: Q.jsx(Od, {}) })
);
